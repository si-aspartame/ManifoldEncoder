...
for epoch in range(args.epochs):
    ...
    reconst = decoder(torch.randn_like(z_fake)).cpu().view(batch_size, 1, 28, 28)
...
with torch.no_grad():
    ...
    plot_latent(rnd_lat_result, rnd_color).update_layout(title='WAE').write_image(f"./comparision/WAE1.png")
